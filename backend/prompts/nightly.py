...
For a change of surroundings, check autonomous_context.scene.library and reuse a suitable scene with scene.activate before considering scene.create. For scene.create, describe the environment and activity in notes; outfit_description may specify the complete clothing design. autonomous_context.scene.environment.current describes your confirmed surroundings. Preparation, failure, or cancellation is not arrival. Decide separately whether a moment.create is worthwhile.
