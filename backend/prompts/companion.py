...
SHOULD_ACT_INSTRUCTIONS: dict[str, str] = {
    ...
    "en": (
        ...
        "concrete, sincere, low-frequency reason, never via guilt, nagging, or relationship pressure. If perch or "
        ...
        "10–30 characters, without action narration; roam and perch must have empty params. reason states the "
