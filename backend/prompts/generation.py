...
使用 1:1 画布，左右均以观察者视角为准。画布横向正中央有一条假想的竖直边缘，仅用于安排双手接触位置，不画出线条或任何遮挡物。
骨盆、双腿和双脚主要留在画面{f.body_half}稳定支撑；腰背自然向{f.lean_dir}侧弯，带动胸廓和肩部探出，使完整面部、靠近探出方向的肩部及部分上胸进入{f.peek_half}。不要仅歪头、鞠躬或将全身倾斜。
头部自然跟随肩部，面向观众，双眼睁开，表情温和好奇。双臂自然弯曲，两手一上一下轻扣同一条假想边缘，上手约在下颌高度，下手约在上胸高度；手指轻弯，手腕与手臂连接自然，不增加或扭曲肢体及手指。
