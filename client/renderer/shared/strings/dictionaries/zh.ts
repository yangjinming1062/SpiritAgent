export const dict = {
  ...
  settings: {
    ...
    persona: {
      characterCard: {
        edit: '编辑',
        title: '角色卡',
        description: '从已确认的头像和全身图整理固定外形。服装、发型、发色、妆容和配饰由外观管理。',
        portrait: '头像',
        body: '全身形象',
        ...
        extract: '重新提取',
        reload: '重新加载',
        saved: '已保存。修改用于后续生成，已有图片和视频不会自动更新。',
      ...
      fullbodyReference: {
        ...
        confirmHint: '确认后自动整理角色卡，再准备默认视频与房间；你可以继续完成引导。',
        adoptHint: '采纳后直接确认这张全身形象，并在后台整理角色卡、准备默认视频与房间。',
        empty: '还没有全身形象，可以根据当前头像与角色设定生成。',
        loading: '正在准备全身形象，请稍候…',
        referenceLabel: '用户参考图',
        refLabel: '参考图（可选，仅「重新生成」时生效）',
        refHint: '补充体型、服装和姿态；身份参照头像，角色卡中明确修改的特征优先。',
  ...
  living: {
    ...
    outfit: {
      ...
      previewPlaceholderIdle: '选择左侧外观预览，或开始设计新外观',
      ...
      processing: '处理中…',
      discard: '放弃草稿',
      confirmHint: '确认后这套外观即就绪，可在列表中随时穿上',
    ...
    appearance: {
      ...
      videoActive: '使用中',
      videoActionPending: '动作尚未就绪',
      videoRedoAction: '重新生成这个动作',
      videoFeedback: '希望怎样调整动作（可选）',
      videoGenAction: '生成视频形象',
      videoRegenAction: '重新生成视频形象',
      videoRegenTitle: '重新生成视频形象',
      videoRegenBody: '将按当前外观参考重新演绎并生成整套动作，完成后自动替换显示并启用。',
    ...
    room: {
      ...
      referenceHint: '可上传房间或带人物的参考图，借鉴布置、氛围，也可要求精灵模仿图中姿势。',
      referenceLabel: '房间参考图',
      chooseReference: '选择参考图',
      replaceReference: '更换参考图',
      removeReference: '移除参考图',
      referenceError: '图片读取失败或过大，请换一张较小的 PNG / JPEG / WebP / GIF 图片。',
      notesLabel: '房间与姿势要求',
      notesPlaceholder: '例如：参考图中的房间，让精灵也侧坐在窗边，保持现在的穿着。',
      noBackdrop: '暂无生效的房间图',
      currentBadge: '当前房间',
      ...
      historyDeleteConfirmTitle: '删除这张历史房间？',
      historyDeleteConfirmDescription:
        '删除后不可恢复，该房间会从回滚历史中移除并腾出名额。当前正在使用的房间不会被删除。',
      policyTitle: '房间政策',
      policyLabel: '角色自主换房',
    ...
    toasts: {
      ...
      roomDeleteFailed: '删除失败…请稍后重试',
      roomDeleteSuccess: '已删除该历史房间',
