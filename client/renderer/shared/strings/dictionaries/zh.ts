export const dict = {
  ...
  living: {
    ...
    appearance: {
      ...
      videoRegenBody: '将按当前外观参考重新演绎并生成整套动作（约 3~10 分钟），完成后自动替换显示并启用。',
      ...
      videoGenStageProcess: '正在抠像、分割动作并编码透明片段…',
      videoGenStagePublish: '正在发布动作包…',
      videoGenStageDefault: '视频形象生成中…',
      videoGenHint:
        '按当前外观参考生成一段包含待机、左右行走和拖拽动作的视频，自动抠像与分割为透明动作包，完成后设为默认形象（约 3~10 分钟）。',
      videoGenRetryHint: '点击生成可重试。',
      modelHint:
