...
export const dict: Dictionary = {
  ...
  selfSource: {
    ...
    poseAttachHint:
      'Optional: attach left/right edge-pose images before confirming; missing sides are generated by the backend.',
    poseLeft: 'Left pose',
    poseRight: 'Right pose',
    poseUpload: 'Upload pose image',
    poseSelfSource: 'Use your own pose',
    poseAttached: 'Attached',
    poseRemove: 'Remove',
