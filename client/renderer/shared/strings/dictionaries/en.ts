...
export const dict: Dictionary = {
  ...
  selfSource: {
    ...
    poseTransparentHint:
      'Poses need a transparent PNG: image generation tools cannot output transparency directly — remove the background in an image editor after generating. Images that keep a background are matted by the backend.',
