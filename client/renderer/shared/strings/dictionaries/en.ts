...
export const dict: Dictionary = {
  ...
  selfSource: {
    ...
    poseAttachHint:
      'Optional: attach your own left/right edge-pose images before confirming; missing sides are generated by the backend.',
    poseTransparentHint:
      'The prompt already includes the transparent-background requirements. Use an image tool that supports transparent output and keep the original PNG file; the actual alpha channel is checked after upload, and images that keep a background are matted by the backend.',
    poseSelfLeft: 'My left pose',
    poseSelfRight: 'My right pose',
    poseRemove: 'Remove',
  ...
  living: {
    ...
    wardrobe: {
      preview: {
        ...
        fullAsset: 'Full texture',
        backdropLight: 'Light backdrop',
        backdropDark: 'Dark backdrop',
        debugMarks: 'Debug marks',
        fullAssetFailed: 'Failed to load the pose texture',
        actions: {
